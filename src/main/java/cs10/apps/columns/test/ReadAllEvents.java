package cs10.apps.columns.test;

import cs10.apps.genesis.joystick.Test;
...
public class ReadAllEvents {
    ...
    public ReadAllEvents() {
        while (true) {
            ...
            for (int i = 0; i < controllers.length; i++) {
                if (!controllers[i].getName().contains("Axis")) continue;
    ...
    public static void main(String[] args) {
        cs10.apps.genesis.joystick.Test test = new Test();
